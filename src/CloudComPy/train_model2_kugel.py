...
def load_data(directory, label):
    ...
    for filename in os.listdir(directory):
        if filename.endswith(".txt"):
            ...
            data_points = read_data_from_txt(filepath)
...
def main():
    ...
    # Modell speichern
    model.save(fr'C:\Users\domin\Documents\Studium\Master\Masterprojekt\src\CloudComPy\models\pointnet_model_v{version}.h5')
