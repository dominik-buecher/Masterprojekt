...
def read_point_cloud(ply_file):
    ...
    return np.hstack((spherical_coords, colors))
...
def load_data(directory, label):
    ...
    for filename in os.listdir(directory):
        if filename.endswith(".ply"):
            ...
            point_cloud = read_point_cloud(filepath)
...
def main():
    ...
    input_shape = (max_points, 6)  # 3 für die Kugelkoordinaten und 3 für die Farben
    ...
    # Modell speichern
    model.save(fr'C:\Users\domin\Documents\Studium\Master\Masterprojekt\src\CloudComPy\models\pointnet_model_kugel_v{version}.h5')
