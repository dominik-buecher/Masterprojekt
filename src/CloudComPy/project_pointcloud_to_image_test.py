...
#point_cloud = o3d.io.read_point_cloud(r"C:\Users\domin\Documents\Studium\Master\Masterprojekt\dataset\pointcloud\pointcloud_noBackround5_only_close.ply")
#point_cloud = o3d.io.read_point_cloud(r"C:\Users\domin\Documents\Studium\Master\Masterprojekt\dataset\pointcloud\pointcloud_noBackround5.ply")
...
image_height_depth = 576

scale_x  = image_width_rgb / sensor_width_rgb
scale_y = image_height_rgb / sensor_height_rgb

scale_x = sensor_width_rgb/sensor_width_depth
scale_y = sensor_height_rgb/sensor_height_depth

scale_x  = image_width_rgb / sensor_width_depth
scale_y = image_height_rgb / sensor_height_depth
...
print("model_parameters_rgb[2] * sensor_width_rgb: ", model_parameters_rgb[2] * sensor_width_rgb)
print("model_parameters_rgb[3] * sensor_height_rgb: ", model_parameters_rgb[3] * sensor_height_rgb)

# model_parameters_rgb[2] *=  sensor_width_rgb
# model_parameters_rgb[3] *=  sensor_height_rgb
model_parameters_rgb[2] *=  image_width_rgb
model_parameters_rgb[3] *=  image_width_rgb * (sensor_height_rgb/sensor_width_rgb)


# model_parameters_rgb[2] *= 1000 * scale_x
# model_parameters_rgb[3] *= 1000 * scale_y
